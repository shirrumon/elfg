...
from elfg.exceptions import NotFound, NotAllowed
from elfg.view import View
from elfg.request import *
from elfg.response import Response
from elfg.middleware import BaseMidlleware

class Elfg:

    __slots__ = ('urls', 'settings', 'middlewares')

    def __init__(self, urls: List[Url], settings: dict, middlewares: List[Type[BaseMidlleware]]):
        self.urls = urls
